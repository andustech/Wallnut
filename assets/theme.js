  ...
  jQuery(function (s) {
    s(document).ready(function () {
      ...
      s(window).scroll(function (t) {
        var o = s(this).scrollTop();
        (e = o > r ? 'down' : 'up'), (r = o);
      }),
        (s.fn.stickUp = function (t) {
          s(this).addClass('stuckMenu');
          var r = 0;
          if (null != t) {
            for (var e in t.parts) t.parts.hasOwnProperty(e) && ((o[r] = t.parts[r]), r++);
            0 == r && console.log('error:needs arguments'),
              (n = t.itemClass),
              (a = t.itemHover),
              null != t.topMargin
                ? 'auto' == t.topMargin
                  ? (u = parseInt(s('.stuckMenu').css('margin-top')))
                  : isNaN(t.topMargin) && t.topMargin.search('px') > 0
                  ? (u = parseInt(t.topMargin.replace('px', '')))
                  : isNaN(parseInt(t.topMargin))
                  ? (console.log('incorrect argument, ignored.'), (u = 0))
                  : (u = parseInt(t.topMargin))
                : (u = 0),
              (i = s('.' + n).size());
          }
          (c = parseInt(s(this).height())),
            (l = parseInt(s(this).css('margin-bottom'))),
            (p = parseInt(s(this).next().closest('div').css('margin-top'))),
            (vartop = parseInt(s(this).offset().top));
        }),
        s(document).on('scroll', function () {
          if (((varscroll = parseInt(s(document).scrollTop())), null != i))
            for (var r = 0; r < i; r++) {
              (t[r] = s('#' + o[r]).offset().top),
                'down' == e &&
                  varscroll > t[r] - 50 &&
                  varscroll < t[r] + 50 &&
                  (s('.' + n).removeClass(a), s('.' + n + ':eq(' + r + ')').addClass(a)),
                'up' == e &&
                  ((v = r),
                  (contentView = 0.4 * s('#' + o[v]).height()),
                  (testView = t[v] - contentView),
                  varscroll > testView
                    ? (s('.' + n).removeClass(a), s('.' + n + ':eq(' + v + ')').addClass(a))
                    : varscroll < 50 &&
                      (s('.' + n).removeClass(a), s('.' + n + ':eq(0)').addClass(a)));
            }
          var v;
          vartop < varscroll + u &&
            (s('.stuckMenu').addClass('isStuck'),
            s('.stuckMenu')
              .next()
              .closest('div')
              .css({ 'margin-top': c + l + p + 'px' }, 10),
            s('.stuckMenu').css('position', 'fixed'),
            s('.isStuck').css({ top: '0px' }, 10, function () {})),
            varscroll + u < vartop &&
              (s('.stuckMenu').removeClass('isStuck'),
              s('.stuckMenu')
                .next()
                .closest('div')
                .css({ 'margin-top': p + 'px' }, 10),
              s('.stuckMenu').css('position', 'relative'));
        });
    });
  });
})();
(function vendorPlaceholder() {
  ...
  !(function (a, b, c) {
      ...
      if ('' == b.value) {
        if ('password' == b.type) {
          if (!d.data('placeholder-textinput')) {
            ...
            a
              .removeAttr('name')
              .data({ 'placeholder-password': !0, 'placeholder-id': f })
              .bind('focus.placeholder', k),
              d.data({ 'placeholder-textinput': a, 'placeholder-id': f }).before(a);
          }
    ...
    var h,
      i,
      d = 'placeholder' in b.createElement('input'),
    ...
    d && e
      ...
      : ((i = f.placeholder =
          function () {
            ...
            return (
              a
                ...
                .not('.placeholder')
                .bind({ 'focus.placeholder': k, 'blur.placeholder': l })
        ...
        (h = {
          ...
          set: function (a, d) {
            var e = c(a);
            return e.data('placeholder-enabled')
              ? ('' == d
                  ? ((a.value = d), a != b.activeElement && l.call(a))
                  : e.hasClass('placeholder')
                  ? k.call(a, !0, d) || (a.value = d)
                  : (a.value = d),
                e)
              : (a.value = d);
          },
  ...
  !(function (a, b) {
    ...
    function k(c) {
      d ||
        ...
        (f.$html = a('html')),
        (f.$body = a('body')),
        (f.$shifts = a([o(g.page), o(g.header)].join(', '))),
        (f.$nav = a(o(g.navigation))),
        f.$shifts.length > 0 &&
          f.$nav.length > 0 &&
          ((d = !0),
          f.$body.on(h.click, o(g.handle), m),
          void 0 !== b.matchMedia &&
            ((f.mediaQuery = b.matchMedia(
              '(max-width:' + (f.maxWidth === 1 / 0 ? '100000px' : f.maxWidth) + ')'
            )),
            f.mediaQuery.addListener(l),
            l())));
    }
    function l() {
      f.mediaQuery.matches ? j.enable() : j.disable();
    }
    function m(a) {
      a.preventDefault(),
        a.stopPropagation(),
        e || (f.$body.hasClass(g.isOpen) ? j.close() : j.open()),
        'touchstart' === a.type && ((e = !0), setTimeout(n, 500));
    }
    function n() {
      e = !1;
    }
    ...
    var c = 'shifter',
      ...
      h = { click: 'touchstart.' + c + ' click.' + c },
      i = { maxWidth: '980px' },
      j = {
        close: function () {
          d &&
            (f.$html.removeClass(g.isOpen),
            f.$body.removeClass(g.isOpen),
            f.$shifts.off(o(c)),
            f.$nav.find('input').trigger('blur'));
        },
        enable: function () {
          d && f.$body.addClass(g.isEnabled);
        },
        destroy: function () {
          d &&
            (f.$html.removeClass(g.isOpen),
            f.$body.removeClass([g.isEnabled, g.isOpen].join(' ')).off(h.click),
            void 0 !== b.matchMedia && f.mediaQuery.removeListener(l),
            (f = {}),
            (d = !1));
        },
        disable: function () {
          d && (j.close(), f.$body.removeClass(g.isEnabled));
        },
        open: function () {
          d && (f.$html.addClass(g.isOpen), f.$body.addClass(g.isOpen), f.$shifts.one(h.click, m));
        },
      };
    a[c] = function (a) {
      return j[a]
        ? j[a].apply(this, Array.prototype.slice.call(arguments, 1))
        : 'object' != typeof a && a
        ? this
...
(function vendorLodash() {
  ...
  (function () {
    ...
    function p(n, t, r, e) {
      var u;
      return (
        (u = n === an) || ((u = xn[r]), (u = (n === u || (n !== n && u !== u)) && !En.call(e, r))),
        u ? t : n
      );
    }
    function s(n) {
    ...
    function m(n, t, r, e, u, o) {
      var i = Pn(n),
        ...
        a = '[object Array]',
        l = '[object Array]';
      i || ((a = kn.call(n)), '[object Arguments]' == a && (a = '[object Object]')),
        f || ((l = kn.call(t)), '[object Arguments]' == l && (l = '[object Object]'));
      var p = '[object Object]' == a && !c(n),
        f = '[object Object]' == l && !c(t);
      return !(l = a == l) || i || p
        ? 2 & u ||
          ((a = p && En.call(n, '__wrapped__')), (f = f && En.call(t, '__wrapped__')), !a && !f)
          ? l
            ? (o || (o = []),
              (a = J(o, function (t) {
                return t[0] === n;
    ...
    function Q(n) {
      return (
        (n = X(n) ? kn.call(n) : ''), '[object Function]' == n || '[object GeneratorFunction]' == n
      );
    }
    function W(n) {
    ...
    function un(n) {
      for (
        var t = -1, r = C(n), e = w(n), u = e.length, o = z(n), i = !!o, o = o || [], c = o.length;
        ++t < u;
    ...
    function Selector(element, index) {
      ...
      function change(value) {
        const $textEl = $(element)
          ...
          .find(`[data-option-index=${option_position}] .brown-text`);
...
theme.ProductGallery = function (context, sectionId, events, Product) {
  ...
  $('.carousel-main', context).on('model:start', function (event, id) {
    if ($('[data-model-id=' + id + ']').closest('ul.slides.product-image-container').length >= 1) {
      $('[data-model-id=' + id + ']')
        .closest('ul.slides.product-image-container')
        .data('flickity')
        .unbindDrag();
    }
  });
  ...
  (function focusControl() {
    ...
    $carousel.on('ready.flickity', function () {
      ...
      var $newMedia = $(
        '[data-product-single-media-wrapper]' + "[data-thumbnail-id='product-template-" + id + "']",
        context
      );
  ...
  (function enlargePhoto() {
    ...
    productFancy.fancybox({
      ...
      buttons: ['fb', 'tw', 'zoom', 'zoom-in-out', 'fullScreen', 'slideShow', 'thumbs', 'close'],
      infobar: true,
  ...
  (function thumbnails() {
    ...
    var $carouselNavCellsImg = $carouselNav.find(
      '.carousel-cell .product-single__thumbnail',
      context
    );
    ...
    $carousel.on('select.flickity', function () {
      ...
      var scrollY =
        $selected.position().top + $carouselNav.scrollTop() - (navHeight + navCellHeight) / 6;
    ...
    if (config.thumbPosition != 'bottom') {
      ...
      $('#thumb-slider-wrapper .product-single__thumbnails-item', context).css(
        'max-width',
        thumbWrapper
      );
      $('#thumb-slider-wrapper .product-single__thumbnails-item img', context).width(
        thumbWrapper + 20
      );
      $('#thumb-slider-wrapper .product-single__thumbnails-item img', context).height(
        thumbWrapper + 20
      );
      ...
      $('.vertical-carousel .thumb-slider-wrapper .thumb-slider-slides', context).css(
        'max-height',
        thumbWrapHeight
      );
    }
    ...
    var switchMedia = function (mediaId) {
      var $currentMedia = $('[data-product-single-media-wrapper]' + ':not(.inactive)', $main);
      ...
      $newMedia
        ...
        .trigger('mediaVisible', [scrollGallery]);
      $otherMedia.removeClass('active-slide').addClass('inactive');
    };
    var setActiveThumbnail = function (mediaId, $el) {
      if (typeof mediaId === 'undefined') {
        mediaId = $('[data-product-single-media-wrapper]:not(.hide)', $main).data('media-id');
      }
      ...
      $thumbnailWrappers.removeClass('active-slide').removeAttr('aria-current');
    ...
    $(document).ready(function () {
      if ($('.carousel-main li', context).first().hasClass('model-slide')) {
        var $el = $('.carousel-main li', context)
          .first()
          .find('[data-product-single-media-wrapper]');

        if (
          $('.carousel-main li', context).closest('ul.slides.product-image-container').length >= 1
        ) {
          $('.carousel-main li', context)
            .closest('ul.slides.product-image-container')
            .data('flickity')
            .unbindDrag();
        }
...
theme.ProductScrollGallery = function (context, sectionId, events, Product) {
  ...
  (function mainImages() {
    ...
    var switchMedia = function (mediaId) {
      ...
      var $newMedia = $(
        '[data-product-single-media-wrapper]' + "[data-thumbnail-id='" + mediaId + "']",
        $main
      );
      var $otherMedia = $(
        '[data-product-single-media-wrapper]' + ":not([data-thumbnail-id='" + mediaId + "'])",
        $main
      );
    ...
    var setActiveThumbnail = function (mediaId, $el) {
      ...
      $item.removeClass('active-slide').removeAttr('aria-current');
    ...
    function enableCarousel() {
      ...
      $('.carousel-main', context).on('model:start', function (event, id) {
        if (
          $('[data-model-id=' + id + ']').closest('ul.slides.product-image-container').length >= 1
        ) {
          $('[data-model-id=' + id + ']')
            .closest('ul.slides.product-image-container')
            .data('flickity')
    ...
    switch (video.host) {
      case hosts.html5:
        ...
        video.player.on('play', (event) => {
          ...
          var $otherMedia = $(
            '[data-product-single-media-wrapper]' + ":not([data-media-id='" + mediaId + "'])",
            context
          );
  ...
  function setupModelViewerListeners(model) {
    ...
    model.$container.on('mediaVisible', function (event, scrollGallery) {
      ...
      if (!scrollGallery) {
        ...
        $('.shopify-model-viewer-ui .shopify-model-viewer-ui__controls-area', model.$container).css(
          'opacity',
          '1'
        );
  ...
  function Slideshow(container) {
    ...
    $(function () {
      ...
      slideWrapper.not('.slick-initialized').slick({
        ...
        arrows: arrows,
        nextArrow:
          '<a class="slick-next slick-arrow"><i class="fas fa-angle-right" aria-hidden="true"></i></a>',
        prevArrow:
          '<a class="slick-prev slick-arrow"><i class="fas fa-angle-left" aria-hidden="true"></i></a>',
        dots: dots,
  ...
  function Map(container) {
    ...
    (function overlay() {
      ...
      function error(message) {
        ...
        element.innerHTML =
          '<div class="map-section-error errors text-center">' + message + '</div>';
      }
    })();
