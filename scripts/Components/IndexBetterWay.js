                ...
                {index % 2 === 0 ? (
                  <div className="video_items_container flex items-center flex-col-reverse md:flex-row mb-14 md:mb-0">
                    <div className="video_content w-full md:w-6/12 md:pr-5 lg:px-13 xl:px-16 pt-6 md:pt-0 pb-0 md:pb-5 lg:pb-0">
                      ...
                      {settings.video_btn_text &&
                        <>
                        <a onClick={() => handleVideoPopup()} href="javascript:void(0);" className="video-open text-white flex items-center link_hover">
                    ...
                    {settings.video_link &&
                      <div tabindex="-1" aria-hidden="true" className={`videoBack fixed ${videoActive}`}>
                        <div class="flex items-start modal-body pr-4 w-11/12 md:w-2/3"> 
                          <video width="100%" height="100%" controls allow={"autoplay"} class="pr-3">
                            <source src={settings.video_link} type="video/mp4" />
                            Your browser does not support the video tag.
                          </video>
                          <button type="button" className="close-button bg-transparent hover:text-gray-900 items-center ml-auto rounded-lg text-gray-400 text-sm" onClick={() => handleVideoPopup()}>
                            <svg className="w-5 h-5" fill="#fff" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                          </button>
                        </div>
                      </div>
                    }
                  ...
                  <div className="how_it_work_items_container flex items-center flex-col md:flex-row">
                    ...
                    <div className="how_it_work_content w-full md:w-6/12 md:pl-5 lg:px-13 xl:px-16 pt-6 md:pt-0">
                      ...
                      {settings.button_text &&
                        <a href={settings.button_link} className="primary_btn mr-6 sm:mr-10">{settings.button_text}</a>
                      }
                      {settings.link_text &&
                        // <a href={settings.link_url} className="text-white hover:text-red-100 flex items-center">
                        //   {settings.link_icon_position == 'before' &&
